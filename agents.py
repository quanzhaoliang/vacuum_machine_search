    ...
    def things_near(self, location, radius=None):
        ...
        for thing in self.things:
            if distance_squared(location, thing.location) <= radius2:
                if thing.location == (location[0], location[1]+1):
                    result.append((thing, up))
                elif thing.location == (location[0], location[1]-1):
                    result.append((thing, down))
                elif thing.location == (location[0]-1, location[1]):
                    result.append((thing, left))
                elif thing.location == (location[0]+1, location[1]):
                    result.append((thing, right))
        return result
